...
print(process_linear((4,3),"d","3"))
print(process_linear("(1,3),sdfg9","3","2"))
print(process_linear("(1,3)","0","2"))
print(process_linear("(1,1),(2,2),(3,3)","1","4"))
print(process_linear("(1,1.2),(2,2.8),(3,8.2)","2","4"))
print(process_linear("(1,3),(40,22)","3","2"))